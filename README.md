...
Functional CSS for max-width-percentages

## Filesize

| File | Size |
|------|------|
| `dist/max-width-percentages.css` | 15649 bytes |
| `dist/max-width-percentages.min.css` | 10235 bytes (1413 Gzipped) |

## Install

```sh
npm install css-max-width-percentages
```
...
```html
<link rel="stylesheet" href="https://unpkg.com/css-max-width-percentages/dist/max-width-percentages.min.css">
```

### Direct

```html
<link rel="stylesheet" href="path/to/css-max-width-percentages/dist/max-width-percentages.min.css">
```
...
| `.mx-wi-1-s` | `max-width: 1%;` |
| `.mx-wi-2-s` | `max-width: 2%;` |
| `.mx-wi-3-s` | `max-width: 3%;` |
| `.mx-wi-4-s` | `max-width: 4%;` |
| `.mx-wi-5-s` | `max-width: 5%;` |
| `.mx-wi-6-s` | `max-width: 6%;` |
| `.mx-wi-7-s` | `max-width: 7%;` |
| `.mx-wi-8-s` | `max-width: 8%;` |
| `.mx-wi-9-s` | `max-width: 9%;` |
| `.mx-wi-10-s` | `max-width: 10%;` |
| `.mx-wi-11-s` | `max-width: 11%;` |
| `.mx-wi-12-s` | `max-width: 12%;` |
| `.mx-wi-13-s` | `max-width: 13%;` |
| `.mx-wi-14-s` | `max-width: 14%;` |
| `.mx-wi-15-s` | `max-width: 15%;` |
| `.mx-wi-16-s` | `max-width: 16%;` |
| `.mx-wi-17-s` | `max-width: 17%;` |
| `.mx-wi-18-s` | `max-width: 18%;` |
| `.mx-wi-19-s` | `max-width: 19%;` |
| `.mx-wi-20-s` | `max-width: 20%;` |
| `.mx-wi-21-s` | `max-width: 21%;` |
| `.mx-wi-22-s` | `max-width: 22%;` |
| `.mx-wi-23-s` | `max-width: 23%;` |
| `.mx-wi-24-s` | `max-width: 24%;` |
| `.mx-wi-25-s` | `max-width: 25%;` |
| `.mx-wi-26-s` | `max-width: 26%;` |
| `.mx-wi-27-s` | `max-width: 27%;` |
| `.mx-wi-28-s` | `max-width: 28%;` |
| `.mx-wi-29-s` | `max-width: 29%;` |
| `.mx-wi-30-s` | `max-width: 30%;` |
| `.mx-wi-31-s` | `max-width: 31%;` |
| `.mx-wi-32-s` | `max-width: 32%;` |
| `.mx-wi-33-s` | `max-width: 33%;` |
| `.mx-wi-34-s` | `max-width: 34%;` |
| `.mx-wi-35-s` | `max-width: 35%;` |
| `.mx-wi-36-s` | `max-width: 36%;` |
| `.mx-wi-37-s` | `max-width: 37%;` |
| `.mx-wi-38-s` | `max-width: 38%;` |
| `.mx-wi-39-s` | `max-width: 39%;` |
| `.mx-wi-40-s` | `max-width: 40%;` |
| `.mx-wi-41-s` | `max-width: 41%;` |
| `.mx-wi-42-s` | `max-width: 42%;` |
| `.mx-wi-43-s` | `max-width: 43%;` |
| `.mx-wi-44-s` | `max-width: 44%;` |
| `.mx-wi-45-s` | `max-width: 45%;` |
| `.mx-wi-46-s` | `max-width: 46%;` |
| `.mx-wi-47-s` | `max-width: 47%;` |
| `.mx-wi-48-s` | `max-width: 48%;` |
| `.mx-wi-49-s` | `max-width: 49%;` |
| `.mx-wi-50-s` | `max-width: 50%;` |
| `.mx-wi-51-s` | `max-width: 51%;` |
| `.mx-wi-52-s` | `max-width: 52%;` |
| `.mx-wi-53-s` | `max-width: 53%;` |
| `.mx-wi-54-s` | `max-width: 54%;` |
| `.mx-wi-55-s` | `max-width: 55%;` |
| `.mx-wi-56-s` | `max-width: 56%;` |
| `.mx-wi-57-s` | `max-width: 57%;` |
| `.mx-wi-58-s` | `max-width: 58%;` |
| `.mx-wi-59-s` | `max-width: 59%;` |
| `.mx-wi-60-s` | `max-width: 60%;` |
| `.mx-wi-61-s` | `max-width: 61%;` |
| `.mx-wi-62-s` | `max-width: 62%;` |
| `.mx-wi-63-s` | `max-width: 63%;` |
| `.mx-wi-64-s` | `max-width: 64%;` |
| `.mx-wi-65-s` | `max-width: 65%;` |
| `.mx-wi-66-s` | `max-width: 66%;` |
| `.mx-wi-67-s` | `max-width: 67%;` |
| `.mx-wi-68-s` | `max-width: 68%;` |
| `.mx-wi-69-s` | `max-width: 69%;` |
| `.mx-wi-70-s` | `max-width: 70%;` |
| `.mx-wi-71-s` | `max-width: 71%;` |
| `.mx-wi-72-s` | `max-width: 72%;` |
| `.mx-wi-73-s` | `max-width: 73%;` |
| `.mx-wi-74-s` | `max-width: 74%;` |
| `.mx-wi-75-s` | `max-width: 75%;` |
| `.mx-wi-76-s` | `max-width: 76%;` |
| `.mx-wi-77-s` | `max-width: 77%;` |
| `.mx-wi-78-s` | `max-width: 78%;` |
| `.mx-wi-79-s` | `max-width: 79%;` |
| `.mx-wi-80-s` | `max-width: 80%;` |
| `.mx-wi-81-s` | `max-width: 81%;` |
| `.mx-wi-82-s` | `max-width: 82%;` |
| `.mx-wi-83-s` | `max-width: 83%;` |
| `.mx-wi-84-s` | `max-width: 84%;` |
| `.mx-wi-85-s` | `max-width: 85%;` |
| `.mx-wi-86-s` | `max-width: 86%;` |
| `.mx-wi-87-s` | `max-width: 87%;` |
| `.mx-wi-88-s` | `max-width: 88%;` |
| `.mx-wi-89-s` | `max-width: 89%;` |
| `.mx-wi-90-s` | `max-width: 90%;` |
| `.mx-wi-91-s` | `max-width: 91%;` |
| `.mx-wi-92-s` | `max-width: 92%;` |
| `.mx-wi-93-s` | `max-width: 93%;` |
| `.mx-wi-94-s` | `max-width: 94%;` |
| `.mx-wi-95-s` | `max-width: 95%;` |
| `.mx-wi-96-s` | `max-width: 96%;` |
| `.mx-wi-97-s` | `max-width: 97%;` |
| `.mx-wi-98-s` | `max-width: 98%;` |
| `.mx-wi-99-s` | `max-width: 99%;` |
| `.mx-wi-100-s` | `max-width: 100%;` |
...
Example: `.mx-wi-1-m` applies the property at the medium breakpoint and above.
...
Processes `src/max-width-percentages.css` with [Lightning CSS](https://lightningcss.dev) and outputs to `dist/`.

- `dist/max-width-percentages.css` — formatted
- `dist/max-width-percentages.min.css` — minified
